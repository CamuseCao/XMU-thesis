...
\begin{center}
	{
		\vspace*{-4ex}
		\raggedright\rmfamily\bfseries\zihao{-4}
		学校编码：10384\qquad 分类号\CJKunderline{\l__xmu_classified_code_tl}\quad 密级 \CJKunderline{\l__xmu_security_classification_tl}\par 
		学号：\l__xmu_studentnumber_tl \qquad UDC\;\CJKunderline{\l__xmu_UDC_tl}\par\vspace{5ex}
